...
<WineQuiz
  ...
  heroAlt="A flight of white wine glasses at a dinner table"
  wines={[
    {
...
<MethodologyBox
  ...
  title="What Makes a Good Beginner White"
  intro="White wine for beginners isn't about finding the fanciest bottle. It's about finding eight bottles that represent the main styles clearly."
  criteria={[
    { title: "One per major style", description: "A beginner's first task is figuring out whether they prefer crisp, aromatic, rich, or sweet. We made sure the list includes a clear example of each style: Pinot Grigio and Sauvignon Blanc for crisp, Chardonnay for rich, Riesling for aromatic, Moscato for sweet." },
    { title: "Recognisable producers where possible", description: "Santa Margherita, Eroica, Damilano, Dog Point: these are names that signal quality even to people who don't follow wine. Beginner confidence is built on recognizable producers, not obscure cult wines." },
    { title: "Clear flavour profile", description: "Every bottle on this list has a distinct, obvious flavour that matches the grape's reputation. No confusing blends or experimental styles. If you drink a Moscato from this list, you'll know what Moscato tastes like." },
    { title: "Widely stocked and under $28", description: "Every bottle ships nationally, and most are available at grocery-store price points. A beginner list you can't actually buy is useless." }
  ]}
/>
