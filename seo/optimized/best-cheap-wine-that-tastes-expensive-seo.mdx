...
<MethodologyBox
  ...
  intro="The bottles on this list were selected from affordable wines priced $15 to $25 on a major wine retailer, sorted by critic score, then filtered against a set of criteria designed to identify genuine overperformers and value wines rather than just affordable bottles with high scores."
  criteria={[
    "Prestige region or producer: wines from Bordeaux, Napa, Provence, Tuscany, or a respected producer with a track record. These are the regions where good value is most reliably found at this price point.",
    ...
    "Complexity over simplicity: wines that taste like expensive bottles have layers, structure, and a finish worth staying with. Single-note fruit-forward wines, however pleasant, weren't selected.",
