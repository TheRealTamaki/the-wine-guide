...
ogImage: '/images/types-of-wine/dessert-wine.webp'
featured: false
draft: false
relatedArticles:
...
**<a href="/grapes/moscato/">Moscato</a> d'Asti.** From Piedmont, Italy, made from the Muscat Blanc grape (locally called Moscato Bianco). Lightly sparkling (frizzante), low in alcohol (around 5.5%), and absolutely bursting with peach, apricot, and orange blossom. This is the gateway dessert wine: low stakes, immediately loveable, pairs with almost any fruit dessert or a cheese plate. Exactly as approachable as it looks.
