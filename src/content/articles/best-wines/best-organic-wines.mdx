...
priority: 1
relatedArticles: [types-of-wine/natural-wine, wine-basics/wine-buying-guide, best-wines/best-non-alcoholic-wines]
---
...
<TopPicksInline picks={[
  {
    ...
    href: "https://www.wine.com/product/clos-henri-otira-sauvignon-blanc-2024/3538160",
    image: "https://assets.wine.com/winecom/image/upload/e_trim/w_200,h_400,c_fit,q_auto:best,fl_progressive/iusnx5qtewowv14ocsyd.jpg",
    score: 96,
...
<AffiliateCTA
  href="https://www.wine.com/product/la-rioja-alta-vina-ardanza-reserva-2019/3024585"
  label="La Rioja Alta Vina Ardanza Reserva 2019"
  store="Wine.com"
  image="https://assets.wine.com/winecom/image/upload/e_trim/w_200,h_400,c_fit,q_auto:best,fl_progressive/pdmflhaai6itlcgjfqw9.jpg"
...
<WineTraits tannin={2} acidity={3} sweetness={1} alcohol={4} body={3} />
...
<AffiliateCTA
  ...
  description="Certified organic Tuscan Sangiovese blend under $20. 91 points James Suckling. Everyday drinking from a dedicated organic producer."
...
<AffiliateCTA
  href="https://www.wine.com/product/domaine-du-colombier-chablis-2023/2945947"
  label="Domaine du Colombier Chablis 2023"
  store="Wine.com"
  image="https://assets.wine.com/winecom/image/upload/e_trim/w_200,h_400,c_fit,q_auto:best,fl_progressive/vti2nbes7plcvqqxf1cm.jpg"
...
<WineQuiz
  ...
  wines={[
    ...
    },
    {
      ...
      blurb: "Certified organic Tuscan Sangiovese blend under $20. 91 points James Suckling. Everyday drinking, proper farming.",
      tags: { food: ["meat", "pasta"], occasion: ["weeknight"], style: ["classic"] }
    },
    {
...
<MethodologyBox
  ...
  title=""
  criteria={[
    { title: "Certified-organic viticulture, not vibes", description: "Every bottle carries a third-party organic certification (USDA Organic, EU Organic, or Demeter biodynamic), backed by independent vineyard and winery inspection. Labels that lean on 'sustainable' or 'low-intervention' language without a certification behind it didn't qualify." },
    { title: "Clean fruit ripeness", description: "Organic farming shows up in the glass when the fruit comes in clean and properly ripe. Every pick reads with focused varietal character, no under-ripe green edges and no flabby over-extraction, because healthy vineyards grow better grapes." },
    { title: "Price-to-quality ratio that earns the organic premium", description: "Organic bottles often carry a price bump over conventional. Every pick had to justify that premium by outperforming comparably priced conventional wines on critic scores, customer ratings, or both. No paying extra for the logo alone." },
    { title: "Style spread across red, white, and rosé", description: "Certified organic is a shelf most people browse with a specific grape or colour in mind. The list covers Sauvignon Blanc, Chardonnay, Pinot Noir, Sangiovese, Tempranillo, Cabernet, and two distinct rosé styles so the category's main intents all get answered." },
    { title: "Regions with organic leadership", description: "The list leans into places where organic farming is a working norm rather than a marketing add-on: Provence, the Loire, Tuscany, Sicily, Marlborough, and Rioja all have deep organic traditions. Bottles from producers with multi-decade organic track records get priority over newcomers." },
    { title: "Critic and customer cross-check", description: "Every bottle clears either a 90-plus score from a recognised critic or 4.0-plus stars across 50-plus verified buyer reviews. Most clear both. Certification alone doesn't get a wine on the list. It has to taste good enough to earn the space." }
  ]}
/>
