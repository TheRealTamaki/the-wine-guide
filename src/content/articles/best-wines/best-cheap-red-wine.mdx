...
<MethodologyBox
  ...
  criteria={[
    {
      title: "$15 to $25 ceiling, priced honestly at the retailer",
      description: "Every bottle sits between $15 and $25 at publication. No bottles that usually retail at $28 and dip to $24 on sale. Consistent pricing matters when the whole point is a cheap red you can restock without rethinking the budget."
    },
    {
      title: "90-point critic floor, or customer density if no critic weighed in",
      description: "Most picks here cleared 90 points from Wine Enthusiast, James Suckling, Wine Spectator, Vinous, Jeb Dunnuck, or Wilfred Wong. Where a bottle has no critic coverage, Claire required 4.5-plus stars from 30 or more verified buyers before it made the cut."
    },
    {
      title: "Tannin and body range across light, medium, and bold buckets",
      description: "The cut deliberately covers Pinot Noir and light Sonoma Coast reds, medium Rhone and Rioja picks, and bold Cabernet and Zinfandel. The trap in cheap red is thin, underripe bottles that let the price down. Every bottle here carries the weight its body bucket promises."
    },
    {
      title: "Dry fermentation, no residual-sugar bailouts",
      description: "Mass-market cheap reds lean on sweetness to cover thin fruit. Every bottle on this list is dry-fermented and sits in the 13 to 14.5 percent ABV range. The flavour comes from the grape and the region, not a sugar correction at the end of fermentation."
    },
    {
      title: "Regional specificity on the label",
      description: "Every bottle names a real appellation: Toro, Uco Valley, Cotes du Rhone, Chianti Rufina, St. Emilion, Alexander Valley, Willamette Valley. Defined regions come with production rules and quality floors that generic 'California Red' labels don't."
    },
    {
      title: "Verified live on the retailer page",
      description: "Claire personally checks every product listing for a live URL, a confirmed product ID, and an in-stock price at the time of writing. If a bottle can't be verified on the day, it doesn't make the cut."
    }
  ]}
/>
...
Everything here lives in the $15 to $25 band, which is where critic-scored, region-specific reds genuinely start. If you need to spend less, our [best wines under $15](/best-wines/best-wines-under-15/) round-up covers the bottles that still hold their own at the lower tier. For a tighter focus on red wine specifically at the $20 ceiling, the [best red wine under $20](/best-wines/best-red-wine-under-20/) page is the closest neighbour to this one.
