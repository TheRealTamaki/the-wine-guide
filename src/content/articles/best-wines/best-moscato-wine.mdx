...
<WineTraits tannin={1} acidity={3} sweetness={3} alcohol={1} body={2} />
...
<WineTraits tannin={1} acidity={3} sweetness={4} alcohol={2} body={2} />
...
<WineTraits tannin={1} acidity={3} sweetness={5} alcohol={3} body={4} />
...
The thirteen bottles above cover the core of the Moscato category, but the wider [Moscato grape](/grapes/moscato/) family is worth a short tour if you want to go deeper.
...
<MethodologyBox
  ...
  title=""
  criteria={[
    { title: "Full Moscato style coverage", description: "Seven Moscato d'Asti, one Asti Spumante, three everyday Moscato wines under $16, and two premium Passito dessert Moscatos from Piedmont and Sicily. The category runs from 5 percent frizzante to 15 percent Passito, and the cut reflects that spread rather than squeezing everything into a single bucket." },
    { title: "Verified low ABV for Moscato d'Asti", description: "Every Moscato d'Asti on the list confirms 5 to 5.5 percent ABV, the range that makes the style the rare wine you can actually drink two glasses of at a long lunch. Producer tech sheets cross-checked before including anything, no assumptions based on label category." },
    { title: "Residual sugar that matches the style", description: "Moscato d'Asti sits around 80 to 110 g/L residual sugar, which reads sweet but clean when the acidity is right. Passito Moscato pushes 200-plus g/L, which is where the dessert-wine concentration lives. Everyday Moscato lands between the two. Every pick carries the sugar its category actually requires." },
    { title: "Producer track record in Piedmont", description: "Saracco, Ceretto, Damilano, Coppo, Viberti, Marenco, La Spinetta, Patrizi: all estates with real history in Piedmontese Moscato, many better known for Barolo and Barbaresco. The everyday category leans on Caposaldo, Centorri, Bartenura, and Martini & Rossi, names with the volume, consistency, and multi-vintage track record that holds up on a weeknight." },
    { title: "Bottles that work as aperitif or dessert", description: "Moscato d'Asti is one of the most food-flexible sweet wines in the market, at its best with peaches, panettone, soft cheese, and brunch. Premium Passito partners with blue cheese, dark chocolate, and fig tart at the end of dinner. Every bottle on the list earns its pairing slot rather than being filed as a sweet afterthought." },
    { title: "Not dismissed as cheap sweet wine", description: "The worst thing most wine writing does to Moscato is treat the whole category as one bottom-shelf tier. A $16 Saracco and a $57 Ben Ryé are both legitimate answers to 'best Moscato,' just for different readers and different tables. Every pick here is the real style done properly, not a mass-market pretender." }
  ]}
/>
