...
<WineQuiz
  ...
  heroAlt="A glass of wine on a brunch table"
  wines={[
    {
      id: "la-marca",
...
Sparkling wine is the most versatile brunch wine, but it's not the only answer. Prosecco, Champagne, Cava, and Crémant all work because the bubbles cut through rich foods, the acidity refreshes between bites, and the lower alcohol content suits a long meal. That said, a creamy Chardonnay handles eggs Benedict better, a Sauvignon Blanc beats sparkling next to avocado toast, and a Moscato d'Asti is the only correct answer for pancakes drowned in maple syrup. Sparkling wine is the safe default. The other styles are the smarter calls when the food on the table demands them.
